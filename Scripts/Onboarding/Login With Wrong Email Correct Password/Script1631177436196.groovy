...
WebUI.setText(findTestObject('Object Repository/Page_Whispa/input_Kindly enter your details to log in_email'), 'cynthia23@enyata.com')
...
WebUI.verifyTextPresent('Admin Login Failed', false)
