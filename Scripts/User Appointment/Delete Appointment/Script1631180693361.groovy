...
WebUI.click(findTestObject('user appointments/img'))

WebUI.click(findTestObject('user appointments/Page_Whispa/user appointments/div_Delete'))

WebUI.click(findTestObject('user appointments/Page_Whispa/user appointments/button_Cancel'))

WebUI.click(findTestObject('user appointments/img'))

WebUI.click(findTestObject('user appointments/Page_Whispa/user appointments/div_Delete'))

WebUI.click(findTestObject('user appointments/Page_Whispa/user appointments/button_Delete'))
