...
WebUI.click(findTestObject('user appointments/Page_Whispa/div_Decline'))

WebUI.click(findTestObject('user appointments/Page_Whispa/button_Cancel'))

WebUI.click(findTestObject('user appointments/img'))

WebUI.click(findTestObject('user appointments/Page_Whispa/div_Decline'))

WebUI.click(findTestObject('user appointments/Page_Whispa/button_Decline'))
